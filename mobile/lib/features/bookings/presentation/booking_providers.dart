...
final myCustomerBookingsProvider = FutureProvider.autoDispose<List<Booking>>((
  ref,
) {
  return ref.watch(bookingRepositoryProvider).getMyBookingsAsCustomer();
});

final myProviderBookingsProvider = FutureProvider.autoDispose
    .family<List<Booking>, String>((ref, providerId) {
      return ref
          .watch(bookingRepositoryProvider)
          .getMyBookingsAsProvider(providerId);
    });

/// Live-updating booking, for the Booking Tracking / Details screen.
final bookingStreamProvider = StreamProvider.autoDispose
